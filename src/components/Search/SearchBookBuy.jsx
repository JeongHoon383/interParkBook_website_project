...
background: url(//qi-b.qoo10cdn.com/renewPark/reBookpark/search/bg_reply.gif) no-repeat 1px 3px;
padding-left: 7px; 
`
...
export default function SearchBookBuy({ book, priceStandard, priceSales, mileage, salesPoint }) {
		...
		<>
			...
			<Searchbookbuycontainer>
				<Searchbookbuyprices>
					...
					<p className="discountedprice">{priceSales}
					</p>
					</Discountedpriceboxup>
				...
				<Bookcartncard>
					...
					<Addbookcart src="https://qi-b.qoo10cdn.com/renewPark/search/btn_bookcart.gif" className="addbookcart" alt=""></Addbookcart>
				
					<Buynow src="https://qi-b.qoo10cdn.com/renewPark/search/btn_buy.gif" className="buynow" alt=""></Buynow>
