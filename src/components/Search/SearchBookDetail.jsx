  ...
  return (
    <>
      <Searchbookdetail>
        ...
        <Link to={`/book/${isbn13}`}>
          <Booksearchdetailimg src={cover}></Booksearchdetailimg>
        </Link>
        <Searchbookdetaillisting>
          <Link to={`/book/${isbn13}`}>
            <Searchbookdetailboldtitle>{title}</Searchbookdetailboldtitle>
          </Link>

          <Searchbookdetailsub>
            <img
              src="https://bimage.interpark.com/renewPark/reBookpark/search/btn_series.gif"
              alt=""
              className="series"
            />
            <img
              src="https://bimage.interpark.com/renewPark/reBookpark/search/bt_smsAlram.gif"
              alt=""
              className="sms"
            />
          </Searchbookdetailsub>
