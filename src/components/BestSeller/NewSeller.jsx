...
export default function BestSeller() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://127.0.0.1:9090/bestseller/${navbar}/${categoryName}/${page}/${itemsCountPerPage}`)
      .then((result) => {
  ...
  return (
    ...
    <Toptop>
      ...
      <Bottomtotal>
        ...
        <Bottomtotalct>
          인터파크 도서의 베스트셀러는 출판유통질서 확립을 위한 베스트셀러 집계/발표 가이드라인 협약을 준수합니다.
        </Bottomtotalct>

        <Bottomtotalct>
          (협약에 따른 변경일: 2018.05.01)
        </Bottomtotalct>
