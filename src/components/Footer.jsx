...
import Main_MoFooter from './Main/Mobile/Main_MoFooter';
            ...
            <div className="center">
              ...
              <div className="company_info">
                <div>
                  <span>(주)인터파크커머스</span>
                  <ul>
                    <li>주소 | 서울특별시 서초구 강남대로 447(서초동,남서울빌딩)</li>
                ...
                <div>
                  ...
                  <ul>
                    <li>고객님은 안전거래를 위해 현금 등으로 결제 시 저희 쇼핑몰에서 가입한</li>
              ...
              <div className="copyright_box">
                <h1>
                  주식회사 인터파크커머스는 인터파크 쇼핑, 인터파크 도서의 통신판매중개자로서 통신판매의 당사자가
                  아니므로, 개별 판매자가 등록한 오픈마켓 상품에 대해서 주식회사 인터파크커머스는 일체 책임을 지지
                  않습니다.
                </h1>
                <span>Copyright © Interpark Commerce Corp. All Rights Reserved.</span>
              </div>
            </div>
          </InfoSection>
        </div>
